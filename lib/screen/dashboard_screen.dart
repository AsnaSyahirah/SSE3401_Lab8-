...
class _DashboardState extends State<DashboardScreen> {
  ...
  void initState() {
    ...
    SchedulerBinding.instance!.addPostFrameCallback((_) {
      SchedulerBinding.instance!.window.onPlatformBrightnessChanged = () {
        setState(() {
          // Check the current brightness and update the mode accordingly
          final brightness =
  ...
  Widget build(BuildContext context) {
    ...
    final lightTheme = ThemeData(
      ...
      // Add your desired light theme settings here
    );
    final darkTheme = ThemeData(
      brightness: Brightness.dark,
      primarySwatch: Colors.deepPurple,
      // Add your desired dark theme settings here
    );

    // Determine the theme based on the ambient light
